...
import com.liangwj.spring.jmxConsole.config.DomainNameFilter;
...
import com.liangwj.spring.jmxConsole.dto.schemas.InvokeOperationParamInfo;
import com.liangwj.spring.jmxConsole.dto.schemas.MBeanVo;
import com.liangwj.spring.jmxConsole.exceptions.BaseApiException;
import com.liangwj.spring.jmxConsole.exceptions.MyAttrNotFoundException;
import com.liangwj.spring.jmxConsole.exceptions.MyJmException;
import com.liangwj.spring.jmxConsole.exceptions.MyMBeanNotFoundException;
import com.liangwj.spring.jmxConsole.exceptions.MyMalformedObjectNameException;
import com.liangwj.spring.jmxConsole.exceptions.MyOperationNotFoundException;
import com.liangwj.spring.jmxConsole.exceptions.SystemErrorException;
import com.liangwj.spring.jmxConsole.utils.ExceptionUtil;
import com.liangwj.spring.jmxConsole.utils.OpenTypeUtil;
...
public class MBeanService {
	...
	private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MBeanService.class);
	...
	private DomainNameFilter domainNameFilter;
	...
	public void changeAttr(JwChangeAttrForm form) throws BaseApiException {
		...
		if (log.isDebugEnabled()) {
			...
			log.debug("改变属性的值: ObjectName={} 属性名={} 表单值=%s 转化后的值={}", form.getObjectName(),
					form.getName(),
	...
	public List<DomainVo> getMBeanList() throws BaseApiException {
		...
		try {
			...
			for (ObjectInstance instance : mbeans) {
				...
				if (this.domainNameFilter.show(domainName)) {
					// 如果过滤器认为这个domain该显示
