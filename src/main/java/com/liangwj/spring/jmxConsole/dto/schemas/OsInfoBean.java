...
public class OsInfoBean implements Serializable {
	private static final long serialVersionUID = -5520028730175985122L;

	@Schema(description = " 提交的虚拟内存")
	private long committedVirtualMemorySize;

	@Schema(description = "空闲的物理内存")
	private long freePhysicalMemorySize;

	@Schema(description = "空闲的交换空间")
	private long freeSwapSpaceSize;

	@Schema(description = "进程导致的CPU负载")
	private double processCpuLoad;

	@Schema(description = "CPU时间")
	private long processCpuTime;

	@Schema(description = "系统的CPU负载")
	private double systemCpuLoad;

	@Schema(description = "总物理内存")
	private long totalPhysicalMemorySize;

	@Schema(description = "总交换空间")
